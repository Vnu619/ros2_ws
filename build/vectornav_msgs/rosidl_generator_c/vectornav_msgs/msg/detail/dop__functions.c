...
{
  vectornav_msgs__msg__DOP * msg = (vectornav_msgs__msg__DOP *)malloc(sizeof(vectornav_msgs__msg__DOP));
  if (!msg) {
    return NULL;
  }
...
vectornav_msgs__msg__DOP__Sequence__init(vectornav_msgs__msg__DOP__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (vectornav_msgs__msg__DOP *)calloc(size, sizeof(vectornav_msgs__msg__DOP));
    if (!data) {
      return false;
    }
...
{
  vectornav_msgs__msg__DOP__Sequence * array = (vectornav_msgs__msg__DOP__Sequence *)malloc(sizeof(vectornav_msgs__msg__DOP__Sequence));
  if (!array) {
    return NULL;
  }
